 ...
 */
public class EmailHostingOrderPage  extends BasePage{
    ...
    @FindBy(xpath = "//*[@id='crazy_order_email_hosting_form']/div[1]/div[3]/div[2]/span")
...
//    private WebHostingProduct finalProduct;
    ...
    public Product getProduct() {
        if (actualProduct != null){
            ...
            actualProduct = new EmailHostingProduct(getProductName());
            actualProduct.setProductPlan(new Plan(getPlanName(), new Term(getOptionTerm())));
            return actualProduct;
        }
